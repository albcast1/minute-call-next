  ...
  '/sobre-nosotros': {
    ...
    build: () =>
      [
        '# Sobre Minute Call',
        '',
        'Minute Call es una empresa española de recepción telefónica y secretaría virtual para PYMES y autónomos. Fundada por Alberto Castiel (ex General Manager de Leocare), opera con agentes nativos basados en España y con recepcionistas de IA.',
        '',
        '- Partners oficiales de Teleperformance (#1 BPO mundial).',
        '- Idiomas de atención: español, inglés y francés.',
        '- Tiempo medio de respuesta: 15 segundos. Tasa de respuesta: 98%.',
        '- Valoración 5,0/5 en Trustpilot.',
        '- Sin permanencia y activación en 48 horas.',
        '',
