...
const services = [
  {
    title: 'Atencion telefonica en sueco nativo',
...
const steps = [
  ...
  { step: '02', title: 'Configuramos el desvio', description: 'Desvías las llamadas en sueco a nuestro equipo. Tus clientes nunca notan que es un servicio externo.' },
    ...
    <>
      ...
      <section style={{ textAlign: 'center', maxWidth: 860, margin: '0 auto', padding: 'clamp(40px,8vw,80px) clamp(16px,5vw,64px) clamp(40px,6vw,60px)' }}>
        <span className="pill-label" style={{ marginBottom: 20, display: 'inline-block' }}>
          Call center y contact center en sueco
        </span>
        <h1>
          Call center en sueco.<br />Atencion telefonica nativa para tus clientes <span className="serif-italic">suecos.</span>
        </h1>
