...
export default function NotFound() {
    return (
          <div className="min-h-[60vh] flex flex-col items-center justify-center px-6 py-24 text-center">
                <p className="text-sm font-medium text-gray-500 mb-4">Error 404</p>p>
                ...
                <div className="mt-12 flex flex-wrap justify-center gap-6 text-sm text-gray-400">
                        <Link href="/lp" className="hover:text-black transition">Sectores</Link>Link>
                        <Link href="/atencion-telefonica" className="hover:text-black transition">Ciudades</Link>Link>
                        <Link href="/articulos" className="hover:text-black transition">Blog</Link>Link>
                        <Link href="/calculadora-roi" className="hover:text-black transition">Calculadora ROI</Link>Link>
                </div>div>
          </div>div>
        )
}</div>
