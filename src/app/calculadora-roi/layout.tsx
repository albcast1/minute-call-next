...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: '¿Cómo puedo reducir las llamadas perdidas?', acceptedAnswer: { '@type': 'Answer', text: 'La forma más efectiva es contratar un servicio de recepcionista virtual o atención telefónica externalizada. Minute Call cubre todas las llamadas, sin permanencia y con activación en 48 horas. Consulta el precio para tu volumen.' } },
  ]}
