...
import { citySummary, parseLimit, searchCities } from '@/lib/api/resources'

/** GET /api/v1/cities - Spanish cities with a coverage page. */
export async function GET(request: NextRequest) {
  ...
  return apiJson({
    ...
    items: matches.slice(0, limit.value).map(citySummary),
  })
}
