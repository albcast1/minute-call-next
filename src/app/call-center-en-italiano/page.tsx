...
export const metadata: Metadata = {
  title: 'Call center en italiano | Contact center en italiano para empresas | minute call',
  description: 'Call center y contact center en italiano para empresas espaÃ±olas. Agentes nativos italÃ³fonos, atenciÃ³n telefÃ³nica 24/7, sin permanencia. Ideal para turismo, comercio internacional y mÃ¡s.',
  alternates: { canonical: 'https://www.minute-call.com/call-center-en-italiano' },
  openGraph: {
    title: 'Call center en italiano | minute call',
    description: 'AtenciÃ³n telefÃ³nica en italiano con agentes nativos. Contact center especializado para empresas que necesitan comunicarse con clientes italÃ³fonos.',
    url: 'https://www.minute-call.com/call-center-en-italiano',
...
const painPoints = [
  {
    icon: 'ð®ð¹',
    title: 'Clientes italianos que cuelgan',
    description: 'Italia es uno de los principales mercados emisores de turistas a EspaÃ±a y un socio comercial estratÃ©gico dentro de la UE. Si llaman y nadie les atiende en italiano, buscan otra opciÃ³n.',
  },
  {
    icon: 'ð',
    title: 'Oportunidades comerciales perdidas',
    description: 'Empresas y clientes italianos que contactan con tu negocio y no consiguen comunicarse. La proximidad cultural no elimina la barrera lingÃ¼Ã­stica.',
  },
  {
    icon: 'ð£ï¸',
    title: 'Traducciones automaticas que no convencen',
    description: 'Un script traducido al italiano no es atenciÃ³n en italiano. Los clientes notan la diferencia y la confianza se pierde.',
  },
  {
    icon: 'ð¼',
    title: 'Contratar un nativo es caro',
    description: 'Incorporar un empleado que hable italiano nativo a tu plantilla supone un coste fijo elevado que muchas empresas no pueden justificar.',
  },
]

const services = [
  {
    title: 'Atencion telefonica en italiano nativo',
    description: 'Agentes nativos en italiano que atienden a tus clientes con fluidez real, no con guiones traducidos.',
  },
  {
    title: 'Soporte multicanal',
    description: 'AtenciÃ³n por telÃ©fono, email y chat en italiano. Tus clientes eligen cÃ³mo contactar.',
  },
  {
  ...
  },
  {
    ...
    description: 'Recibimos llamadas de clientes italianos, procesamos reservas, consultas y pedidos siguiendo tu protocolo.',
  },
  {
    title: 'Filtrado y clasificacion de llamadas',
    description: 'Clasificamos cada llamada en italiano por tipo: venta, soporte, incidencia. Solo te pasamos lo que necesita tu atenciÃ³n.',
  },
  {
...
const stats = [
  ...
  { value: '100%', label: 'italiano nativo' },
  { value: '48h', label: 'ActivaciÃ³n' },
  { value: '0', label: 'Permanencia' },
]

const steps = [
  { step: '01', title: 'Definimos tu protocolo', description: 'Nos cuentas cÃ³mo quieres que atendamos a tus clientes italÃ³fonos: tono, informaciÃ³n clave, procedimientos y escalado.' },
  { step: '02', title: 'Configuramos el desvio', description: 'DesvÃ­as las llamadas en italiano a nuestro equipo. Tus clientes nunca notan que es un servicio externo.' },
  { step: '03', title: 'Atendemos como tu equipo', description: 'Gestionamos cada llamada en italiano nativo siguiendo tu protocolo. Recibes un resumen detallado de cada interacciÃ³n.' },
]
...
const faqSchema = {
  ...
  '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: 'Â¿QuÃ© es un call center en italiano?', acceptedAnswer: { '@type': 'Answer', text: 'Es un servicio de atenciÃ³n telefÃ³nica con agentes nativos en italiano que atienden a tus clientes como parte de tu equipo. Siguen tu protocolo, usan tus herramientas y representan tu marca.' } },
    { '@type': 'Question', name: 'Â¿Vuestros agentes son italianos nativos?', acceptedAnswer: { '@type': 'Answer', text: 'SÃ­. Nuestros agentes son hablantes nativos de italiano â no usan traducciones ni scripts. Entienden las referencias culturales y el registro que tus clientes esperan.' } },
    { '@type': 'Question', name: 'Â¿Para quÃ© sectores es Ãºtil un contact center en italiano?', acceptedAnswer: { '@type': 'Answer', text: 'Turismo y hostelerÃ­a, moda, diseÃ±o, alimentaciÃ³n, comercio internacional, inmobiliarias con compradores italianos y logÃ­stica.' } },
    { '@type': 'Question', name: 'Â¿Puedo activar el servicio solo cuando lo necesite?', acceptedAnswer: { '@type': 'Answer', text: 'SÃ­. No hay permanencia ni compromiso de duraciÃ³n. Puedes activar la atenciÃ³n en italiano para temporadas altas, campaÃ±as puntuales o de forma continuada â tÃº decides.' } },
    { '@type': 'Question', name: 'Â¿CuÃ¡nto cuesta un call center en italiano?', acceptedAnswer: { '@type': 'Answer', text: 'El precio depende del volumen de llamadas y la complejidad del servicio. Contacta con nosotros para un presupuesto personalizado sin compromiso.' } },
...
export default function CallCenterItalianoPage() {
  return (
    <>
      ...
      <section style={{ textAlign: 'center', maxWidth: 860, margin: '0 auto', padding: 'clamp(40px,8vw,80px) clamp(16px,5vw,64px) clamp(40px,6vw,60px)' }}>
        <span className="pill-label" style={{ marginBottom: 20, display: 'inline-block' }}>
          Call center y contact center en italiano
        </span>
        <h1>
          Call center en italiano.<br />Atencion telefonica nativa para tus clientes <span className="serif-italic">italianos.</span>
        </h1>
        <p style={{ maxWidth: 600, margin: '0 auto 32px' }}>
          Contact center en italiano con agentes nativos para empresas espaÃ±olas. Atendemos a tus clientes de Italia y Suiza italiana â sin permanencia y con activaciÃ³n en 48 horas.
        </p>
      ...
      <section style={{ maxWidth: 1200, margin: '0 auto', padding: 'clamp(40px,8vw,80px) clamp(20px,5vw,64px)', textAlign: 'center' }}>
        ...
        <h2 style={{ marginTop: 16 }}>
          Por que pierdes clientes italianos sin un call center en <span className="serif-italic">italiano.</span>
        </h2>
      ...
      <section style={{ maxWidth: 1200, margin: '0 auto', padding: 'clamp(40px,8vw,80px) clamp(20px,5vw,64px)', textAlign: 'center' }}>
        ...
        <h2 style={{ marginTop: 16 }}>
          Que incluye nuestro contact center en <span className="serif-italic">italiano.</span>
        </h2>
      ...
      <section style={{ background: 'black', color: 'white', textAlign: 'center', padding: 'clamp(40px,8vw,80px) clamp(20px,5vw,64px)' }}>
        <h2 style={{ color: 'white' }}>
          Atiende a tus clientes italianos como se <span className="serif-italic">merecen.</span>
        </h2>
        <p style={{ color: 'rgba(255,255,255,0.6)', maxWidth: 500, margin: '0 auto 32px' }}>
          Activa tu call center en italiano en 48 horas. Sin permanencia, agentes nativos.
        </p>
