...
export const metadata: Metadata = {
  title: 'Call center en italiano para empresas | minute call',
  description: 'Call center en italiano con agentes nativos para empresas españolas. Atención 24/7 y sin permanencia, ideal para turismo y comercio internacional.',
  alternates: { canonical: 'https://www.minute-call.com/call-center-en-italiano' },
  openGraph: {
    title: 'Call center en italiano | minute call',
    description: 'Atención telefónica en italiano con agentes nativos. Contact center especializado para empresas que necesitan comunicarse con clientes italófonos.',
...
const painPoints = [
  {
    ...
    description: 'Italia es uno de los principales mercados emisores de turistas a España y un socio comercial estratégico dentro de la UE. Si llaman y nadie les atiende en italiano, buscan otra opción.',
  },
  {
    icon: '📉',
    title: 'Oportunidades comerciales perdidas',
    description: 'Empresas y clientes italianos que contactan con tu negocio y no consiguen comunicarse. La proximidad cultural no elimina la barrera lingüística.',
  },
  {
    icon: '🗣️',
    title: 'Traducciones automaticas que no convencen',
    description: 'Un script traducido al italiano no es atención en italiano. Los clientes notan la diferencia y la confianza se pierde.',
  },
  {
    icon: '💼',
...
const services = [
  ...
  },
  {
    ...
    description: 'Atención por teléfono, email y chat en italiano. Tus clientes eligen cómo contactar.',
  },
  {
  ...
  },
  {
    ...
    description: 'Clasificamos cada llamada en italiano por tipo: venta, soporte, incidencia. Solo te pasamos lo que necesita tu atención.',
  },
  {
...
const steps = [
  { step: '01', title: 'Definimos tu protocolo', description: 'Nos cuentas cómo quieres que atendamos a tus clientes italófonos: tono, información clave, procedimientos y escalado.' },
  { step: '02', title: 'Configuramos el desvio', description: 'Desvías las llamadas en italiano a nuestro equipo. Tus clientes nunca notan que es un servicio externo.' },
  { step: '03', title: 'Atendemos como tu equipo', description: 'Gestionamos cada llamada en italiano nativo siguiendo tu protocolo. Recibes un resumen detallado de cada interacción.' },
]
...
const faqSchema = {
  ...
  '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: '¿Qué es un call center en italiano?', acceptedAnswer: { '@type': 'Answer', text: 'Es un servicio de atención telefónica con agentes nativos en italiano que atienden a tus clientes como parte de tu equipo. Siguen tu protocolo, usan tus herramientas y representan tu marca.' } },
    { '@type': 'Question', name: '¿Vuestros agentes son italianos nativos?', acceptedAnswer: { '@type': 'Answer', text: 'Sí. Nuestros agentes son hablantes nativos de italiano — no usan traducciones ni scripts. Entienden las referencias culturales y el registro que tus clientes esperan.' } },
    { '@type': 'Question', name: '¿Para qué sectores es útil un contact center en italiano?', acceptedAnswer: { '@type': 'Answer', text: 'Turismo y hostelería, moda, diseño, alimentación, comercio internacional, inmobiliarias con compradores italianos y logística.' } },
    { '@type': 'Question', name: '¿Puedo activar el servicio solo cuando lo necesite?', acceptedAnswer: { '@type': 'Answer', text: 'Sí. No hay permanencia ni compromiso de duración. Puedes activar la atención en italiano para temporadas altas, campañas puntuales o de forma continuada — tú decides.' } },
    { '@type': 'Question', name: '¿Cuánto cuesta un call center en italiano?', acceptedAnswer: { '@type': 'Answer', text: 'El precio depende del volumen de llamadas y la complejidad del servicio. Contacta con nosotros para un presupuesto personalizado sin compromiso.' } },
    ...
    <>
      ...
      <section style={{ textAlign: 'center', maxWidth: 860, margin: '0 auto', padding: 'clamp(40px,8vw,80px) clamp(16px,5vw,64px) clamp(40px,6vw,60px)' }}>
        ...
        <p style={{ maxWidth: 600, margin: '0 auto 32px' }}>
          Contact center en italiano con agentes nativos para empresas españolas. Atendemos a tus clientes de Italia y Suiza italiana — sin permanencia y con activación en 48 horas.
        </p>
