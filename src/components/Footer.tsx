          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            <nav style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              ...
              <div style={{ marginTop: 16 }}>
                ...
                <Link href="/lp/recepcionista-ia-clinicas" style={{ fontSize: 14, color: "rgba(0,0,0,0.56)", display: "block", marginBottom: 0 }}>Clínicas</Link>
                <Link href="/lp/recepcionista-ia-inmobiliarias" style={{ fontSize: 14, color: "rgba(0,0,0,0.56)", display: "block", marginBottom: 0 }}>Inmobiliarias</Link>
                <Link href="/lp/recepcionista-ia-restaurantes" style={{ fontSize: 14, color: "rgba(0,0,0,0.56)", display: "block", marginBottom: 0 }}>Hostelería</Link>
                <Link href="/lp/recepcionista-ia-abogados" style={{ fontSize: 14, color: "rgba(0,0,0,0.56)", display: "block", marginBottom: 0 }}>Abogados</Link>
                <Link href="/lp/recepcionista-ia-clinicas-dentales" style={{ fontSize: 14, color: "rgba(0,0,0,0.56)", display: "block", marginBottom: 0 }}>Dentistas</Link>
                <Link href="/lp/recepcionista-ia-asesorias" style={{ fontSize: 14, color: "rgba(0,0,0,0.56)", display: "block", marginBottom: 0 }}>Asesorías</Link>
                <Link href="/lp/recepcionista-ia-veterinarias" style={{ fontSize: 14, color: "rgba(0,0,0,0.56)", display: "block", marginBottom: 0 }}>Veterinarias</Link>
                <Link href="/lp/recepcionista-ia-seguros" style={{ fontSize: 14, color: "rgba(0,0,0,0.56)", display: "block", marginBottom: 0 }}>Seguros</Link>
